...
ActiveRecord::Schema.define(version: 2018_06_28_043743) do
  ...
  create_table "feeds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["animal_id"], name: "index_feeds_on_animal_id"
    t.index ["food_id"], name: "index_feeds_on_food_id"
    t.index ["lot_id"], name: "index_feeds_on_lot_id"
  end
